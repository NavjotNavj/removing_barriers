...
import 'package:removing_barriers/medicinesManager/database/repository.dart';
import 'package:removing_barriers/medicinesManager/helpers/snack_bar.dart';
import 'package:removing_barriers/medicinesManager/models/medicine_type.dart';
import 'package:removing_barriers/medicinesManager/models/pill.dart';
import 'package:removing_barriers/medicinesManager/notifications/notifications.dart';
  ...
  Future savePill() async {
    ...
    if (setDate.millisecondsSinceEpoch <=
      ...
      Pill pill = Pill(
          ...
          type: selectWeight,
          notifyId: Random().nextInt(10000000), id: Random().nextInt(10000000));
