...
class MedicinesHelperHome extends StatefulWidget {
  @override
  _MedicinesHelperHomeState createState() => _MedicinesHelperHomeState();
}

class _MedicinesHelperHomeState extends State<MedicinesHelperHome> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget addButton = FloatingActionButton(
      ...
      onPressed: () async {
        ...
        await Navigator.pushNamed(context, "/home/medicinesHelper/add_new_medicine")
            .then((_) => setData());
      },
      child: Icon(
        Icons.add,
